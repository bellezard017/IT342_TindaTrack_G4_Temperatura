        ...
        btnJoin.setOnClickListener {
            ...
            lifecycleScope.launch {
                try {
                    ...
                    OfflineStore.createStaffSession(this@StaffRegisterActivity, name, email, storeCode)
                    Toast.makeText(this@StaffRegisterActivity, "Backend unavailable. Created an offline account.", Toast.LENGTH_LONG).show()
                    startActivity(
                        Intent(this@StaffRegisterActivity, MainActivity::class.java)
                            .addFlags(Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK)
                    )
